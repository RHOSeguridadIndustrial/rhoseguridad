...
function ensureRhoFooter(){
  if(!document.getElementById('rho-global-footer-style')){
    ...
    style.textContent=`
      ...
      .rho-global-footer__logo{
        font-size:clamp(54px,8vw,86px);
        font-weight:800;
        line-height:.95;
        letter-spacing:.01em
      }
      .rho-global-footer__logo .r{color:#fff}
      .rho-global-footer__logo .h{color:#f15a24}
      .rho-global-footer__logo .o{color:#4ca500}
      .rho-global-footer__sub{
        margin-top:14px;
        font-size:clamp(18px,2.6vw,28px);
        line-height:1.2;
        font-weight:400
      }
      .rho-global-footer__copy{
        margin-top:24px;
        font-size:clamp(14px,2.3vw,24px);
        line-height:1.35;
        font-weight:400
      }
      .rho-global-footer__privacy{
      ...
      .rho-global-footer__privacy:hover,
      .rho-global-footer__privacy:focus{color:#cfe7bd}
